...
Demo app is deployed on Heroku. Please check it out: https://forum-app.herokuapp.com/
...
### Documentations
* [API Docs](https://github.com/ahmer-yasin/forum-app/blob/master/docs/api.md)
* [System Overview](https://github.com/ahmer-yasin/forum-app/blob/master/docs/system_overview.md)
...
```
$ git clone https://github.com/ahmer-yasin/forum-app
```
...
The application is created with lots of ♥. Any pull request, issues and contribution is very appreciated. It would be really great if we can take this application to the next level, where it can be used as a platform for forums.
 ...
 - [Ahmer Yasin](https://github.com/ahmer-yasin)

 - [Linkedin](https://www.linkedin.com/in/ahmeryasin/)
